...
ggplot(STL_spend, aes(x = FY, y = Roadmap_projects, label = Roadmap_amounts)) +
  geom_line(aes(y = Roadmap_projects * 500, group = 1, linetype = "# of projects"), color = "blue", size = 1.7) +
  ...
  theme_bw() + ggtitle("STL Roadmap Funded") + 
  geom_text(aes(label = label_number_si()(Roadmap_amounts*1000)), vjust = -0.5, color = "white") +
  theme(
